  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-950 to-black text-white">
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        <button className="bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-red-700 px-10 py-4 rounded-full text-lg font-bold transition transform hover:scale-105">
          Create Free Account
        </button>
      </section>
      ...
      <footer className="border-t border-gray-800 py-8">
        <div className="container mx-auto px-6 text-center text-amber-400">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-sm">© 2024 Resonance Team</div>
          </div>
        </div>
      </footer>
    </div>
