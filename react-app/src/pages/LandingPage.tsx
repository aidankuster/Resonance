      ...
      <section className="container mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center mb-20">
          <button
            ...
            className="bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-yellow-700 hover:to-amber-700 px-8 py-4 rounded-full text-lg font-bold flex items-center justify-center gap-2 transition"
          >
        ...
        <form
          ...
          className="max-w-3xl mx-auto bg-gray-900 rounded-2xl p-2 flex flex-col md:flex-row items-center gap-4"
        >
          ...
          <div className="flex items-center gap-4 px-4">
            <button
              type="submit"
              className="bg-amber-600 hover:bg-yellow-700 px-6 py-3 rounded-full font-semibold"
            >
              Search
            </button>
          </div>
