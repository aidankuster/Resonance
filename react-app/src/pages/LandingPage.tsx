...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Fade out images as user scrolls down
      const maxScroll = 400;
      const newOpacity = Math.max(0, 0.6 * (1 - scrollY / maxScroll));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-950 to-black text-white relative overflow-hidden">
      {/* Left Campus Image - Circular fade */}
      <div
        className="fixed left-0 top-0 bottom-0 w-64 lg:w-80 xl:w-96 pointer-events-none z-0 hidden md:block transition-opacity duration-300"
        style={{
          backgroundImage: `radial-gradient(circle at left center, 
            rgba(0,0,0,0.1) 0%,
            rgba(0,0,0,0.05) 40%,
            transparent 70%,
            transparent 100%
          ), url('/landingpage2.jpg')`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
          opacity: scrollOpacity,
          maskImage: `radial-gradient(circle at left center, 
            black 0%,
            black 40%,
            transparent 80%,
            transparent 100%
          )`,
          WebkitMaskImage: `radial-gradient(circle at left center, 
            black 0%,
            black 40%,
            transparent 80%,
            transparent 100%
      ...
      {/* Right Campus Image - Circular fade */}
      <div
        className="fixed right-0 top-0 bottom-0 w-64 lg:w-80 xl:w-96 pointer-events-none z-0 hidden md:block transition-opacity duration-300"
        style={{
          backgroundImage: `radial-gradient(circle at right center, 
            rgba(0,0,0,0.1) 0%,
            rgba(0,0,0,0.05) 40%,
            transparent 70%,
            transparent 100%
          ), url('/landingpage1.jpg')`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
          opacity: scrollOpacity,
          maskImage: `radial-gradient(circle at right center, 
            black 0%,
            black 40%,
            transparent 80%,
            transparent 100%
          )`,
          WebkitMaskImage: `radial-gradient(circle at right center, 
            black 0%,
            black 40%,
            transparent 80%,
            transparent 100%
      ...
      {/* Top Gradient Overlay - fades out with scroll */}
      <div
        ...
        style={{
          ...
          opacity: Math.min(1, scrollOpacity * 1.5),
        }}
      />

      {/* Content - Higher z-index to appear above images */}
      <div className="relative z-10">
        ...
        <header className="sticky top-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <Link to={isAuthenticated ? "/dashboard" : "/userinitiation"}>
              <button className="bg-amber-600 hover:bg-amber-700 px-10 py-4 rounded-full text-lg font-bold transition transform hover:scale-105 shadow-xl">
        ...
        <section className="container mx-auto px-6 py-20 text-center">
          ...
          <Link to={isAuthenticated ? "/dashboard" : "/userinitiation"}>
            <button className="bg-amber-600 hover:bg-amber-700 px-10 py-4 rounded-full text-lg font-bold transition transform hover:scale-105 inline-flex items-center gap-2 shadow-xl">
        ...
        <section id="how-it-works" className="container mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center bg-gray-900/40 backdrop-blur-sm rounded-2xl p-8 border border-gray-800/50">
        ...
        <section id="features" className="container mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 hover:bg-gray-800/70 transition border border-gray-700">
              ...
              <p className="text-gray-300">
                Connect exclusively with verified UNCP music students. Build
                your network and create new opportunities.
              </p>
            </div>
        ...
        {/* CTA */}
        <section className="container mx-auto px-6 py-20 text-center">
          <div className="bg-gray-900/40 backdrop-blur-sm rounded-3xl p-12 max-w-3xl mx-auto border border-gray-800/50">
